...
This code builds constructors, assigns them capacity and size values, tests if the
vectors are equal, deletes the last input, inputs into the desired location, and
...
3
v1*v2=30
capacity: 4size: 4val: 1 2 3 4 capacity: 16size: 4val: 1 2 3 4 capacity: 2size: 4val: 5 6 7 8
enter your choice 0-8:
0
*/
